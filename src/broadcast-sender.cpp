...
void loop()
{
    ...
    Serial.println("Broadcast Message to Channel 4");
    ResponseStatus rs = e32ttl.sendBroadcastFixedMessage(0x04, "This Message is from 01 00 04 Device on Broadcast.");
